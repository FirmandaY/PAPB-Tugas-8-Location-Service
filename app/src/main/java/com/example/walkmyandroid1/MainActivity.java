...
public class MainActivity extends AppCompatActivity implements FetchAddressTask.OnTaskCompleted{
    ...
    private FusedLocationProviderClient mFuserLocationClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFuserLocationClient = LocationServices.getFusedLocationProviderClient(this);
    ...
    private  void  getLocation(){
        ...
        != PackageManager.PERMISSION_GRANTED){
            ...
            mFuserLocationClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
                @Override
